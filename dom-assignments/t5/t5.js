...
navigator.geolocation.getCurrentPosition(
    (position) => {
      ...
      reference.location.coordinates[0] = lat;
      reference.location.coordinates[1] = lon;
    },
    (error) => {
      console.error("Error getting location:", error);
    }
  );
var map = L.map('map').setView([reference.location.coordinates[1],reference.location.coordinates[0]], 13);
...
for(const restaurant of restaurants){
    var marker = L.marker([restaurant.location.coordinates[1],restaurant.location.coordinates[0]]).addTo(map);
